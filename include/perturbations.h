 ...
 */
#define _MAX_NUMBER_OF_K_FILES_ 100000 /*vp: increased for CONCEPT*/
...
struct perturbations_workspace
{
  ...
  int index_mt_delta_rho_smg;        /**< delta_rho of the effective smg fluid (absolute; always finite) */
  ...
  */
  ...
  double tca_shear_g;  /*asd*< photon shear in tight-coupling approximation */
